"""Build PrivacyPeek attacker training dataset."""

from __future__ import annotations

import argparse

from attacker.privacypeek_dataset import build_privacypeek_attacker_dataset, default_cases_dir


def main() -> None:
    parser = argparse.ArgumentParser(description="Build PrivacyPeek attacker dataset")
    parser.add_argument(
        "--cases-dir",
        type=str,
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="./data/privacypeek_attacker",
